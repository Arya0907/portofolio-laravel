...
<body>
	...
	<div class="splashscreen">
		<div class="preloader">
			<span class="preloader__text">Tungguin</span>
		</div>
	</div>
	...
	<div id="top" class="navigation">
		<div class="navigation__wrapper wrapper--large">
			<a class="navigation__logo logo" href="#0">AS</a>
	...
	<header class="header">
		<div class="introduction">
			<h1 class="introduction__content">
				<span class="introduction__content-el introduction__content-el--name">M Arya Saputra</span>
	...
	<footer class="footer">
		<div class="footer__wrapper wrapper--large">
			<p class="footer__copyright no-margin">&copy; 2024 Muhamad Arya Saputra</p>
			<a class="footer__logo logo" href="#0">AS</a>
